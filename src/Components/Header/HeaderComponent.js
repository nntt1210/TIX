...
import ULStyles from "./../TagUL/style";
import LIStyles from "./../TagLi/style";
import LinkStyles from "./../TagLink/style";
  ...
  render() {
    ...
    return (
      <Box className={classes.root}>
        ...
        <Box className={classes.rightmobile + " " + classes.menudropdown}>
          <img
            className="img-fluid"
